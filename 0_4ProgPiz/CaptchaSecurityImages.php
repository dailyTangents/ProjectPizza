...
//	var $font = 'helpers/101! Star Lit Nght.ttf';
	...
	function CaptchaSecurityImages($width='350',$height='120',$characters='5') {
		...
		$text_color = imagecolorallocate($image, 20, $height, $width);
...
$height = isset($_GET['height']) ? $_GET['height'] : '120';
